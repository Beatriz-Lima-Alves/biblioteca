<?php include "Views/Templates/header.php"; ?>
    <div class="row">
        <div class="col text-left">
            <h1 class="text-white">Dados da empresa</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="nombre"><i class="fa fa-address-card" aria-hidden="true"></i> Nome</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="telefono"><i class="fa fa-phone-square" aria-hidden="true"></i> Telefone</label>
                                <input id="telefono" class="form-control" type="text" name="telefono" value="<?php echo $data['telefono']; ?>" required placeholder="Telefone">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="direccion"><i class="fa fa-home" aria-hidden="true"></i> Bairro</label>
                                <input id="direccion" class="form-control" type="text" name="direccion" value="<?php echo $data['direccion']; ?>" required placeholder="Bairro">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
