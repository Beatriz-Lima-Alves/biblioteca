...
class Libros extends Controller
{
    public function __construct()
    {
        ...
        $perm = $this->model->verificarPermisos($id_user, "Livros");
        if (!$perm && $id_user != 1) {
        ...
        if (empty($titulo) || empty($autor) || empty($editorial) || empty($materia) || empty($cantidad)) {
            ...
            if (!empty($name)) {
                ...
                if (!in_array($extension, $formatos_permitidos)) {
                    $msg = array('msg' => 'Arquivo não permitido', 'icono' => 'warning');
                } else {
                    $imgNombre = $fecha . ".jpg";
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    ...
                    $msg = array('msg' => 'Livro registrado', 'icono' => 'success');
                } else if ($data == "existe") {
                    $msg = array('msg' => 'O livro já existe', 'icono' => 'warning');
                } else {
                ...
                if ($data == "modificado") {
                    ...
                    $msg = array('msg' => 'Livro modificado', 'icono' => 'success');
                } else {
    ...
    public function eliminar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Livro desativado', 'icono' => 'success');
        } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Livro restaurado', 'icono' => 'success');
        } else {
