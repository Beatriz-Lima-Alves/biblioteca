...
/**
 * Classe para tratar strings e texts
 *
 * @author Raquel
 *
 */
class TexturizeController
{
    /**
     ...
     * @see https://core.trac.wordpress.org/browser/tags/3.9/src/wp-includes/formatting.php?order=name
     * @since 1.2.1
     *
     * @param string $string
